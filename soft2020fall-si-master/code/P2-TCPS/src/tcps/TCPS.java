...
public class TCPS
{
    ...
    while(true){
        new connectClientHandler(serverSocket.accept()).start();

    }}



    private static class connectClientHandler extends Thread {

        private Socket openSocket;

        public connectClientHandler(Socket openSocket){
        ...
        public void connectClient() throws IOException {
            ...
            in = new Scanner(this.openSocket.getInputStream());
            out = new PrintWriter(this.openSocket.getOutputStream(), true);
