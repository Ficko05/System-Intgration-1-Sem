...
//        System.out.println("Server accepts requests at: " + openSocket);
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                new Thread(new connectClient(serverSocket.accept())).start();
    ...
    private static class connectClient extends Thread {

        private final Socket clintSocket;

        private connectClient(Socket socket) {
            this.clintSocket = socket;
        }
